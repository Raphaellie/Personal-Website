...
```{=html}
<a href="assets/papers/racialized-police.pdf"><button type="button" class="btn btn-outline-primary btn-sm">PDF</button></a>
<button type="button" class="btn btn-outline-info btn-sm">HTML</button>
<button type="button" href="https://github.com/raphaellie/racialized-police"  class="btn btn-outline-success btn-sm">GitHub</button>
```
```{r}
...
[PDF](assets/papers/local-images.pdf){.btn .btn-outline-primary .btn-sm role="button"} [HTML](..\about.qmd){.btn .btn-outline-info .btn-sm role="button"} [GitHub](https://github.com/raphaellie/racialized-police){.btn .btn-outline-success .btn-sm role="button"}
