...
-   [Program Evaluation for Public Service](https://evalf21.classes.andrewheiss.com/)[^2]
-   [stat545.com](https://stat545.com/)[^3]
...
[^2]:  Not really a book or a standalone website, but the course material for a course Dr. Andrew Heiss taught at the Andrew Young School of Policy Studies at Georgia State University. All of Dr. Heiss' material is g-o-l-d. See his page [here](https://www.andrewheiss.com/).

[^3]: The same as the previous footnote, but this is the course material for Jenny Bryan's course on statistics at the University of British Columbia. [Happy Git](https://happygitwithr.com/index.html) is also part of that course.
