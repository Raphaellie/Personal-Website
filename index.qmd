...
![](assets/images/profile.jpg){style="border-radius: 50%;"}
:::
...
[{{< fa user >}} CV](assets/cv/Wang-CV.pdf){.badge .bg-dark style="text-decoration: none;"} [{{< fa envelope >}} Email](mailto:chyrwang@gmail.com){.badge .bg-dark style="text-decoration: none;"} [{{< fa brands twitter >}} Twitter](https://twitter.com/raphael_cwang){.badge .bg-dark style="text-decoration: none;"} [{{< fa brands github >}} GitHub](https://github.com/Raphaellie){.badge .bg-dark style="text-decoration: none;"}
